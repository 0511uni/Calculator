...
namespace Calculator_1
{
    ...
    {
        internal static void BmiCalCreate(TextBox allCalBox, TextBox heightBox, TextBox weightBox, TextBox bmiBox)
        {
        ...
        internal static void BaseWeightCalCreate(TextBox allCalBox, TextBox heightBox, TextBox weightBox, TextBox baseWeightBox)
        {
            string height = heightBox.Text;
